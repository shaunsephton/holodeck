...
from holodeck.utils import generate_shard_database_settings
import os
import sys
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PATH, 'holodeck.sqlite'),              # Or path to database file if using sqlite3.
