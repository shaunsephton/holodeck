...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dashboard.share_key'
        db.add_column('holodeck_dashboard', 'share_key',
                      self.gf('django.db.models.fields.CharField')(max_length=32, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dashboard.share_key'
        db.delete_column('holodeck_dashboard', 'share_key')
