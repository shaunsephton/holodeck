...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Sample', fields ['timestamp', 'metric', 'string_value']
        db.create_unique('holodeck_sample', ['timestamp', 'metric_id', 'string_value'])


    def backwards(self, orm):
        # Removing unique constraint on 'Sample', fields ['timestamp', 'metric', 'string_value']
        db.delete_unique('holodeck_sample', ['timestamp', 'metric_id', 'string_value'])
